...
/* Declare Default_Handler prototype to be aliased by all not-implemented ISRs */
void Default_Handler(void);

void Reset_Handler(void);
void NMI_Handler(void) __attribute__((weak, alias("Default_Handler"))); // this creates an alias named "NMI_Handler" to symbol Default_Handler
...
void FPU_Global_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void SPI4_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void SPI5_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void Quad_SP_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void I2CFMP1_event_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void I2CFMP1_error_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));

/* Vector table declared in a separate section .isr_vector to be placed at the very beginning of the program, addr 0x0 */
uint32_t vectors[] __attribute__((section(".isr_vector"))) = {
	SRAM_END,		/* Used to initizlize stack pointer */
	...
	(uint32_t)FPU_Global_IRQHandler,
	0x0U,
	0x0U,
	0x0U,
	...
	0x0U,
	0x0U,
	(uint32_t)Quad_SP_IRQHandler,
	0x0U,
	0x0U,
	(uint32_t)I2CFMP1_event_IRQHandler,
	(uint32_t)I2CFMP1_error_IRQHandler
};
